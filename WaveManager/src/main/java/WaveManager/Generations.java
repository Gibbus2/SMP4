...
public class Generations {
    private final ArrayList<Genome> generations;
    ...
    public void reproduce(){
        ...
        if(generations.size() < 2){
            ...
            Genome parent1 = generations.get(parent1Index);
            Genome parent2 = generations.get(parent2Index);
